# -*- coding: utf-8 -*-
"""
Rebuild nav_from_positions.py into a clean, stable version.

Goal:
- Compute GROSS NAV from positions_daily_filled (uses close_ffill + cash snapshot).
- Compare against nav_daily.nav_gross (not nav, since nav includes costs).
- Avoid fragile patching / indentation drift.

This script OVERWRITES:
  src/alpha_tracker2/pipelines/nav_from_positions.py
"""
